...
user4 = User.create!(email: 'AnnKim@gmail.com', fname: 'Ann', lname: 'Kim', password: 'password', bio: "Web developer", pronouns: 'she/her/hers', location: "NY");
user5 = User.create!(email: 'ArleenPandher@gmail.com', fname: 'Arleen', lname: 'Pandher', password: 'password', bio: "Web developer", pronouns: 'she/her/hers', location: 'Canada');
...
user10 = User.create!(email: 'HarshaBandi@gmail.com', fname: 'Harsha', lname: 'Bandi', password: 'password', bio: "Web developer", pronouns: 'he/him/his', location: "CA");
...
user20 = User.create!(email: 'JJZhang@gmail.com', fname: 'JJ', lname: 'Zhang', password: 'password', bio: "Web developer", pronouns: 'she/her/hers', location: "SF");
user21 = User.create!(email: 'LaneyLuong@gmail.com', fname: 'Laney', lname: 'Luong', password: 'password', bio: "Web developer", pronouns: 'she/her/hers', location: "SF");
user22 = User.create!(email: 'MichelleHuang@gmail.com', fname: 'Michelle', lname: 'Huang', password: 'password', bio: "Web developer", pronouns: 'she/her/hers', location: "SF");
user23 = User.create!(email: 'AyceLacap@gmail.com', fname: 'Ayce', lname: 'Lacap', password: 'password', bio: "Web developer", pronouns: 'she/her/hers', location: "SF");
user24 = User.create!(email: 'DarrenEid@gmail.com', fname: 'Darren', lname: 'Eid', password: 'password', bio: "Web developer", pronouns: 'he/him/his', location: "CA");
user25 = User.create!(email: 'SpencerIascone@gmail.com', fname: 'Spencer', lname: 'Iascone', password: 'password', bio: "Web developer", pronouns: 'he/him/his', location: "CA");
user26 = User.create!(email: 'DiegoChavez@gmail.com', fname: 'Diego', lname: 'Chavez', password: 'password', bio: "Web developer", pronouns: 'he/him/his', location: "CA");
user27 = User.create!(email: 'YuHuanW@gmail.com', fname: 'YuHuan', lname: 'W', password: 'password', bio: "Web developer", pronouns: 'he/him/his', location: "CA");
